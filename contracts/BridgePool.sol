  ...
  using SafeERC20 for IERC20;
    ...
    bool public initialized;
     ...
     modifier onlyAuthorized() {
         require(bridge == _msgSender() || _msgSender() == controller.owner() , "Only Authurized Callable");
        _; 
     }
    ...
    function withdraw(address poolAddress , uint256 amount) public nonReentrant poolInitialized{ 
         ...
         require(pools[poolAddress].deposited  >= amount && balance  >= amount , "Insufficent Pool Balance");
    ...
    function sendOut(address poolAddress , address receiver , uint256 amount) public onlyBridge poolInitialized{
       ...
       uint256 balance;
        ...
        require( pools[poolAddress].overFlow + pools[poolAddress].deposited >= amount && balance >= amount , "Insufficent Pool Balance");
    ...
    function topUp(address poolAddress, uint256 amount) public payable onlyBridge poolInitialized{
