...
contract Settings {
     ...
     event NetworkGasUpdated(uint256 chainId, uint256 prevValue, uint256 newValue);
     ...
     constructor (IController _controller , address payable _feeRemitance ,  address payable _gasBank) {
