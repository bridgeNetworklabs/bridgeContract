...
contract settings{
    ...
    function setApprovedToAdd(address user , address token , bool status) public {
        onlyAdmin();
    ...
    function setMinValidation(uint256 _minValidation) public{
        minValidations = _minValidation;
    }
